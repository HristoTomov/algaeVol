...
algaeVol <- function(Y, alpha) {
        ...
        return(c("tType"= tType, "Significance" = Significance, "polyDegree" = polyDegree, "Slope" = Slope, "Direction" = Direction))
